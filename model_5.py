...
class Encoder_cover(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Sequential(nn.Conv1d(80, 512, 3, 1, 1),
                                  nn.LeakyReLU(0.1),
...
class Encoder_ste(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Sequential(nn.Conv1d(240, 1024, 3, 1, 1),
                                  nn.LeakyReLU(0.1),
        ...
        self.conv1 = nn.Sequential(nn.Conv1d(240, 1024, 4, 1, 1),
                                   nn.LeakyReLU(0.1),
                                   nn.Conv1d(1024, 1024, 4, 1, 2),
                                   nn.LeakyReLU(0.1),
                                   nn.Conv1d(1024, 1024, 3, 1, 1, get_padding(3, 1)),
                                   nn.LeakyReLU(0.1),
                                   nn.Conv1d(1024, 1024, 3, 1, 5, get_padding(3, 5)),
        ...
        self.conv2 = nn.Sequential(nn.Conv1d(240, 1024, 5, 1, 2),
                                   nn.LeakyReLU(0.1),
                                   nn.Conv1d(1024, 1024, 3, 1, 1, get_padding(3, 1)),
                                   nn.LeakyReLU(0.1),
                                   nn.Conv1d(1024, 1024, 3, 1, 5, get_padding(3, 5)),
...
class Deconder_msg(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Sequential(nn.Conv1d(80, 1024, 3, 1, 1),
                                  nn.LeakyReLU(0.1),
                                  nn.Conv1d(1024, 1024, 3, 1, 1, get_padding(3, 1)),
                                  nn.LeakyReLU(0.1),
                                  nn.Conv1d(1024, 1024, 3, 1, 5, get_padding(3, 5)),
        ...
        self.conv1 = nn.Sequential(nn.Conv1d(80, 1024, 4, 1, 1),
                                   nn.LeakyReLU(0.1),
                                   nn.Conv1d(1024, 1024, 4, 1, 2),
                                   nn.LeakyReLU(0.1),
                                   nn.Conv1d(1024, 1024, 3, 1, 1, get_padding(3, 1)),
        ...
        self.conv2 = nn.Sequential(nn.Conv1d(80, 1024, 5, 1, 2),
                                   nn.LeakyReLU(0.1),
                                   nn.Conv1d(1024, 1024, 3, 1, 1, get_padding(3, 1)),
                                   nn.LeakyReLU(0.1),
                                   nn.Conv1d(1024, 1024, 3, 1, 5, get_padding(3, 5)),
