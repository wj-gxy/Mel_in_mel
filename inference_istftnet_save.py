...
with torch.no_grad():
    for i, batch in enumerate(test_loader):
        ...
        y_g_hat = generate_gaussian_noise(y_g_hat, 0.01) #gaussian
        # re_y = generate_speckle_noise(re_y, 0.01) #speckle
        ...
        sf.write(f'/home/lgd/miniconda3/envs/all/Mel_in/robustness/gau_0.01/secret{i}.wav', secret, 22050)
        sf.write(f'/home/lgd/miniconda3/envs/all/Mel_in/robustness/gau_0.01/re_sec{i}.wav', re_sec, 22050)
