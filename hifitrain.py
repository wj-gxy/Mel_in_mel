...
from hifi_model import Generator, MultiPeriodDiscriminator, MultiScaleDiscriminator, feature_loss, generator_loss, \
    discriminator_loss
...
def main():
    ...
    parser.add_argument('--input_wavs_dir',
                        default='/home/lgd/miniconda3/envs/dataset/LJSpeech-1.1/wavs')  # /home/lgd/miniconda3/envs/dataset/aishell3
    ...
    parser.add_argument('--checkpoint_path',
                        default='/home/lgd/miniconda3/envs/all/Mel_in/cp_hifigan/hifigan/only_hifigan')
    parser.add_argument('--config',
                        default='/home/lgd/miniconda3/envs/all/Mel_in/cp_hifigan/hifigan/hifigan_lj/config.json')
