...
from istftnet_model import Generator, MultiPeriodDiscriminator, MultiScaleDiscriminator, feature_loss, generator_loss, \
    discriminator_loss
...
def train(rank, a, h):
    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
        ...
        for i, batch in enumerate(train_loader):
            ...
            optim_g.zero_grad()
            loss_mel = F.l1_loss(x_mel_loss, y_g_hat_mel_loss) * 45
            loss_mel_ser = F.l1_loss(y_mel, re_serect_mel) * 225
            ...
            loss_gen_all = loss_gen_s + loss_gen_f + loss_fm_s + loss_fm_f + loss_mel + loss_mel_ser
                ...
                if steps % a.validation_interval == 0:  # and steps != 0:
                    ...
                    with torch.no_grad():
                        for j, batch in enumerate(validation_loader):
                            ...
                            if j <= 4:
                                if steps == 0:
                                    sw.add_audio('gt/y_{}'.format(j), x_aud[0], steps, h.sampling_rate)
                                    sw.add_figure('gt/y_spec_{}'.format(j), plot_spectrogram(x_mel[0]), steps)
                        ...
                        sw.add_scalar("validation/mel_spec_error", val_err_ser, steps)
...
def main():
    ...
    parser.add_argument('--input_wavs_dir', default='/home/lgd/miniconda3/envs/dataset/LJSpeech-1.1/wavs')
    #'/home/lgd/miniconda3/envs/dataset/aishell3'
    ...
    parser.add_argument('--checkpoint_path',
                        default='/home/lgd/miniconda3/envs/all/Mel_in/cp_hifigan/istftnet/lj')
    parser.add_argument('--config',
                        default='/home/lgd/miniconda3/envs/all/Mel_in/cp_hifigan/istftnet/lj/config_v1.json')
